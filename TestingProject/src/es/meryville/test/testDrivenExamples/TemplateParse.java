...
/*
	The public parse method is basically an outline describing an algorithm,
	which first parses the input into segments, then adds the remaining tail of plain
	text after the last variable placeholder, and, if the list of segments found would otherwise
	remain empty, adds an empty string to represent a zero-length template*/
